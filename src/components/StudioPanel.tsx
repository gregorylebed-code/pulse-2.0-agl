...
export default function StudioPanel({ open, onClose, onShuffle, theme, onThemeChange, classLabel, onClassLabel }: StudiopanelProps) {
          ...
          >
            ...
            <div className="p-4 bg-slate-50 rounded-2xl">
              <div className="flex items-center gap-2 mb-3">
                ...
                <div>
                  <p className="text-[13px] font-bold text-slate-700">Accent Color</p>
                  <p className="text-[11px] text-slate-400">Changes app color for recording</p>
                </div>
              </div>
