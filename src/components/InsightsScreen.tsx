          ...
          <FullScreenCard title={expandedTitles[expandedCard]} onBack={() => setExpandedCard(null)}>
            ...
            {expandedCard === 'streak' && (
              streakStudents.length === 0 ? (
                ...
                <>
                  <div className="flex items-center justify-end mb-4 gap-3 text-[10px] font-bold text-slate-300">
              ...
              notesPerStudent.length === 0 ? (
                ...
                <>
                  ...
                  <div className="flex items-center gap-4 mt-5 pt-3 border-t border-slate-100">
                    <span className="flex items-center gap-1.5 text-[10px] font-bold text-slate-400"><span className="w-2.5 h-2.5 rounded-sm bg-sage inline-block" /> 3+ notes</span>
                    <span className="flex items-center gap-1.5 text-[10px] font-bold text-slate-400"><span className="w-2.5 h-2.5 rounded-sm bg-amber-300 inline-block" /> 1–2 notes</span>
                    <span className="flex items-center gap-1.5 text-[10px] font-bold text-slate-400"><span className="w-2.5 h-2.5 rounded-sm bg-red-300 inline-block" /> not logged</span>
                  </div>
                </>
              )
            )}
